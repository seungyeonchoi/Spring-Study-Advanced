...
public class TemplateMethodTest {
    ...
    void templateMethodV2() {
        ...
        log.info("클래스 이름1={}", template1.getClass()); //class hello.advanced.template.TemplateMethodTest$1
        template1.execute();
        ...
        log.info("클래스 이름2={}", template2.getClass()); //class hello.advanced.template.TemplateMethodTest$2
        template2.execute();
    }
}
